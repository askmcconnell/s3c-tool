...
docname = "draft-mcconnell-software-status-wellknown-01"
category = "info"
...
[seriesInfo]
name = "Internet-Draft"
value = "draft-mcconnell-software-status-wellknown-01"
stream = "independent"
...
: A URI identifying the specification that defines this schema. When
  ...
  (e.g., `"https://datatracker.ietf.org/doc/draft-mcconnell-software-status-wellknown/"`).
  This field is self-documenting: it allows a human or tool encountering
  an unfamiliar `software-status.json` resource to locate the governing
  specification without prior knowledge.
